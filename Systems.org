...
(define geekcave-system
  (operating-system
   ...
   ;; File systems
   (file-systems (cons* (file-system ;; Games
...
* Dropcity
#+begin_src scheme :tangle (concat (cdr (assoc 'guix-manifest-home file-paths)) "/dropcity.scm") :mkdirp yes
;; This file is auto-generated. Do not make changes manually.
;; Exported from Systems.org

(define-module (dropcity)
  #:use-module (base-system)
  #:use-module (gnu)
  #:use-module (gnu packages admin)
  #:use-module (gnu packages certs)
