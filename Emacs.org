...
- [[#things-to-do][Things to do]]
  ...
  - [[#packages][Packages]]
  - [[#add-marginaliavertico-to-theme][Add Marginalia/Vertico to theme]]
  - [[#make-temp-buffers-for-compilation-doom-reload-work][Make temp buffers for compilation (doom-reload) work]]
- [[#modules][Modules]]
...
- [[#basic-settings][Basic Settings]]
  ...
  - [[#launching-external-applications][Launching External Applications]]
...
** TODO Add Marginalia/Vertico to theme
** TODO Make temp buffers for compilation (doom-reload) work
* Modules
...
[[https://github.com/minad/corfu][Corfu]] offers a minimalist =completion-in-region= enhancement.
...
* Local Variables
# Local Variables:
# eval: (add-hook 'after-save-hook (lambda () (if (y-or-n-p "Reload Emacs profile?") (message (shell-command-to-string "update-manifest emacs")))) nil t)
