...
I would like to use =C-SPC= as my leader and =C-SPC C-SPC= as my localleader key in both normal and insert state. To do that, I first need to unbind =C-SPC= completely. Fortunately, DOOM provides the handy =map!= macro.
