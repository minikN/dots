...
** Guix Profiles
I use GNU/Guix as my operating system of choice (it's great, you should too!). In addition to that, I use [[https://guix.gnu.org/cookbook/en/html_node/Guix-Profiles-in-Practice.html][profiles]] to install needed packages. For this to work, I need to create manifest files at =guix-manifest-home=.

| Type         | Content                           |
|--------------+-----------------------------------|
| Guix Profile | =guix-manifest-home/desktop.scm=  |
| Guix Profile | =guix/manifest/home/browsers.scm= |
...
#+begin_src scheme :tangle (concat (cdr (assoc 'guix-manifest-home file-paths)) "/browsers.scm") :noweb yes :mkdirp yes
;; This file is auto-generated. Do not make changes manually.
;; Exported from Desktop.org
...
#+begin_src scheme :noweb-ref browsers
"ungoogled-chromium-wayland"
#+end_src

*** Nyxt
[[https://github.com/atlas-engineer/nyxt][Nyxt]] is a web browser written in Common Lisp.
...
#+begin_src sh
fpath=( "${GUIX_EXTRA_PROFILES}/desktop/desktop/share/zsh/plugins" $fpath )
#+end_src
...
**** Prompt
Just a simple prompt that displays the execution time of the last command.
...
**** Auto suggestions
#+begin_src sh
source "${fpath[1]}/zsh-autosuggestions/zsh-autosuggestions.zsh"
#+end_src
...
**** Syntax highlighting
#+begin_src sh
source "${fpath[1]}/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh"
#+end_src
...
for_window [app_id=".blueman-manager-real"] border pixel
for_window [app_id=".blueman-services-real"] floating enable
for_window [app_id=".blueman-services-real"] border pixel
for_window [app_id="pavucontrol"] floating enable
for_window [app_id="pavucontrol"] border pixel
#+end_src
...
},
{
    ...
    "height": 10,
    "modules-center": ["sway/window", "sway/mode"],
    "modules-right": [ "cpu", "memory", "custom/gpu", "disk#root", "disk#games", "temperature", "network", "pulseaudio", "clock", "tray"],
...
@define-color light @theme-fg;
@define-color warning @theme-orange;
@define-color critical @theme-red;
@define-color mode @theme-b3;
@define-color workspacesfocused @theme-b3;
@define-color tray @workspacesfocused;
@define-color sound @theme-orange;
@define-color network @theme-b3;
@define-color memory @theme-b3;
@define-color cpu @theme-b3;
@define-color temp @theme-b3;
@define-color layout @theme-b3;
@define-color battery @theme-b3;
@define-color date @theme-b3;
@define-color time @theme-b3;
@define-color backlight @theme-b3;
@define-color nord_bg @theme-b3;
@define-color nord_bg_blue @theme-b3;
@define-color nord_light @theme-b8;
@define-color nord_light_font @theme-b8;
...
#waybar {
    background: @bg;
    color: @light;
    font-family: "Iosevka Fixed Extended, Cozette";
    font-size: 12px;
    font-weight: bold;
    border-bottom: 3px solid @theme-b3;
}
...
echo '{"text": "'$clock' GHz,  '$temperature'°C, '$busypercent'%", "class": "custom-gpu", "tooltip": "<b>'$deviceinfo'</b>\n'$driverinfo'"}'
#+end_src
