...
*** Functions
It's always a good idea to have some handy functions helping maintaining the system.

This function lets me easily install/update manifest files into profiles. I may update this in the future if I see the need for it. For now, it's enough. All my manifests get tangled into =$XDG_CONFIG_HOME/guix/manifests= and my profiles are located at =$GUIX_EXTRA_PROFILES=.
